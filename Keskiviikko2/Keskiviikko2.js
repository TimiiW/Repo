...
else if(yksi < kaksi && yksi < kolme && yksi < neljä && yksi < viisi && kolme < kaksi && kolme < neljä && kolme < viisi && neljä < viisi && viisi < kaksi)
{
  document.write("Järjestys on: " + yksi + ' ' + kolme + ' ' + neljä + ' ' + viisi + ' ' + kaksi)
}
else if(yksi < kaksi && yksi < kolme && yksi < neljä && yksi < viisi && neljä < viisi && neljä < kaksi && neljä < kolme && viisi < kaksi && kaksi < kolme)
{
  document.write("Järjestys on: " + yksi + ' ' + neljä + ' ' + viisi + ' ' + kaksi + ' ' + kolme)
}
else if(yksi < kaksi && yksi < kolme && yksi < neljä && yksi < viisi && viisi < kaksi && viisi < neljä && viisi < kolme && kaksi < kolme && kaksi < neljä)
{
  document.write("Järjestys on: " + yksi + ' ' + viisi + ' ' + kaksi + ' ' + kolme + ' ' + nejä)
}


else if(kaksi < yksi && kaksi < kolme && kaksi < neljä && kaksi < viisi && yksi < kolme && yksi < neljä && yksi < viisi && kolme < neljä && kolme < viisi && )
{
